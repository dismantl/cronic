Original found here: https://habilis.net/cronic/. This fork adds the --noerr option if you want to ignore stderr output and only trigger an email on a non-zero exit code.
...
list was still active, I would submit the rant below to gain membership. (feedback to: chuck@habilis.net)
